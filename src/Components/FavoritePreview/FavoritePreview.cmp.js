...
const FavoritePreview = ({
  ...
  const handleDelete = () => {
    ...
    cogoToast.success(
      `Successfully deleted ${favorite.cityName} from favorites`
    );
  };
      ...
      <div className="cards-container">
        <div className="box">
          ...
          <div className="info">
            ...
            <h2 className="temp">
              {((favorite.temperature.Imperial.Value - 32) / 1.8).toFixed()}{" "}
              &deg;C | {favorite.temperature.Imperial.Value} &deg;F
            </h2>
          </div>
        </div>
      </div>
