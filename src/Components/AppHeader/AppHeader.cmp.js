...
const AppHeader = ({ setDarkMode, setFahrenheitToggle }) => {
  ...
  return (
    <div>
      <nav
        className={`${isDarkMode ? "is-dark" : ""} navbar`}
        role="navigation"
      ...
      >
        <div className="navbar-brand">
          <Link className="logo" to="/">
            <img
              src="https://i.imgur.com/5qdECQv.png"
              style={{ padding: "10px" }}
              alt="logo"
              width="220"
            />
        ...
        <div
          ...
          className={`${burgerActive ? "is-active" : ""} navbar-menu`}
        >
          <div className="navbar-end">
            <div className="navbar-item">
              <div className="buttons" style={{ justifyContent: "center" }}>
                ...
                >
                  {isFahre ? "Celsius" : "Fahrenheit"}
                </div>
                <Link className="button is-light" to="/">
                  HOME
                </Link>
                <Link className="button is-light" to="/favorites">
                  FAVORITES
                </Link>
              </div>
            </div>
...
const mapDispatchToProps = dispatch => ({
  ...
  setFahrenheitToggle: setFahrenheit =>
    dispatch(setFahrenheitToggle(setFahrenheit))
});
